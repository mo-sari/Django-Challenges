...
class CaptionTags(models.Model):
...
class Followers(models.Model):
    ...
    follower = models.ForeignKey('Users', models.DO_NOTHING, related_name='followers_follower_set')
...
class HashtagsPosts(models.Model):
    hashtag = models.ForeignKey(Hashtags, models.DO_NOTHING)
    post = models.ForeignKey('Posts', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'hashtags_posts'
